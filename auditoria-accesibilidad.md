...
| <img src="img-auditoria/image.png" width="auto"> |

|        Errores de Contraste         |      Estructura (Encabezados)       |     Características (Imágenes)      |
| :---------------------------------: | :---------------------------------: | :---------------------------------: |
| <img src="img-auditoria/image-1.png" width="400"> | <img src="img-auditoria/image-2.png" width="400"> | <img src="img-auditoria/image-3.png" width="400"> |
...
<img src="img-auditoria/image-4.png" width="auto">

|             Performance             |            Accesibilidad            |          Buenas Prácticas           |                 SEO                 |
| :---------------------------------: | :---------------------------------: | :---------------------------------: | :---------------------------------: |
| <img src="img-auditoria/image-5.png" width="400"> | <img src="img-auditoria/image-6.png" width="400"> | <img src="img-auditoria/image-7.png" width="400"> | <img src="img-auditoria/image-8.png" width="400"> |
...
<img src="img-auditoria/image-9.png" width="auto">

|          Detalle Contraste           |           Error en Listas            |            Contenedor ul             |             Falta de H1              |
| :----------------------------------: | :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-10.png" width="400"> | <img src="img-auditoria/image-11.png" width="400"> | <img src="img-auditoria/image-12.png" width="400"> | <img src="img-auditoria/image-13.png" width="400"> |
...
<img src="img-auditoria/image-25.png" width="auto">

|           Detalle Errores            |        Estructura (Falta H1)         |
| :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-26.png" width="400"> | <img src="img-auditoria/image-27.png" width="400"> |
...
<img src="img-auditoria/image-29.png" width="auto">

|             Performance              |               Detalles               |            Accesibilidad             | Mejores prácticas                    |
| :----------------------------------: | :----------------------------------: | :----------------------------------: | ------------------------------------ |
| <img src="img-auditoria/image-28.png" width="400"> | <img src="img-auditoria/image-30.png" width="400"> | <img src="img-auditoria/image-31.png" width="400"> | <img src="img-auditoria/image-32.png" width="400"> |
...
<img src="img-auditoria/image-33.png" width="auto">

|               Botones                |               Enlaces                |                Selecs                |
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-34.png" width="400"> | <img src="img-auditoria/image-34.png" width="400"> | <img src="img-auditoria/image-36.png" width="400"> |

|            Falta de main             |             falta de h1              |         Puntos de referencia         |
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-37.png" width="400"> | <img src="img-auditoria/image-38.png" width="400"> | <img src="img-auditoria/image-39.png" width="400"> |
...
<img src="img-auditoria/image-51.png" width="600" alt="Resumen General WAVE Artículos">

|    Detalle de Etiquetas Faltantes    |         Estructura Detectada         |
| :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-52.png" width="400"> | <img src="img-auditoria/image-53.png" width="400"> |
...
<img src="img-auditoria/image-54.png" width="600" alt="Resumen Axe DevTools Artículos">

|      Error en Select Categoría       |        Error en Select Orden         |
| :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-55.png" width="400"> | <img src="img-auditoria/image-56.png" width="400"> |

---

## **Análisis de la página de Gestión de Artículos (`inventario.html`)**
...
| :----------------------------------: | :----------------------------------: | ------------------------------------ | ------------------------------------ |
| <img src="img-auditoria/image-67.png" width="400"> | <img src="img-auditoria/image-66.png" width="400"> | <img src="img-auditoria/image-65.png" width="400"> | <img src="img-auditoria/image-64.png" width="400"> |
...
| :-----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-16.png" width="400">  | <img src="img-auditoria/image-14.png" width="400"> |
...
![Evidencia de sintaxis - home](img-auditoria/image-17.png)
...
**Objetivo:** Implementar atributos accesibles en controles de formulario.

### 1. Etiquetado de Formularios

Se han resuelto los 52 errores de "Missing form label":

- **Filtros Estáticos:** `aria-label` en Búsqueda y Selectores.
- **Tabla Dinámica:** Inyección de `aria-label="Stock físico para {Nombre}"` en cada input de fila.
...
![Evidencia de navegabilidad - Home](img-auditoria/image-18.png)
...
<img src="img-auditoria/image-40.png" height="250px"> 
...
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-41.png" width="400"> | <img src="img-auditoria/image-42.png" width="400"> | <img src="img-auditoria/image-43.png" width="400"> |
...
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-57.png" width="400"> | <img src="img-auditoria/image-48.png" width="400"> | <img src="img-auditoria/image-59.png" width="400"> |

---

## **INVENTARIO**

**Objetivo:** Implementar navegación por teclado robusta (WAI-ARIA Tabs).

### 1. Refactorización a Tabs ARIA

- **Estructura:** Rol `tablist` -> `tab` -> `tabpanel`.
- **Interacción:** Navegación con flechas (Roving Tabindex).
- **Estado:** Gestión de `aria-selected` y `hidden`.
...
**Objetivo:** Mejorar la experiencia auditiva en listas de datos densas.

### **1. Celdas Verbosas (Screen Reader Only)**

Para evitar la fatiga auditiva de escuchar solo valores ("12", "Aceite", "5.00"), se han inyectado etiquetas invisibles en cada celda:

- **Antes:** "12345" (Leído como "doce mil...")
- **Ahora:** "Código: 1, 2, 3, 4, 5" (Leído dígito a dígito)

```javascript
// inventarioController.js
// Separación con comas para forzar pausa en lectores
...
### **2. Semántica de Tabla**

- Se añadió `scope="col"` a todos los encabezados (`<th>`) para garantizar la asociación correcta en modos de navegación vertical/horizontal.

### **3. Refinamiento de Lectura (Feedback Usuario)**

Se han realizado ajustes finos basados en pruebas de usabilidad:

- **Lectura de Stock:** En la tabla de consolidación, el lector ahora anuncia el contexto completo al recibir foco: _"Stock actual para [Producto] es de [X], ingresar Stock real"_.
- **Códigos Numéricos:** Se forzó la separación por comas en los códigos (`1, 2, 3, 4`) para evitar que los lectores los interpreten como cifras millonarias ("Doce mil...").
...
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-19.png" width="400"> | <img src="img-auditoria/image-20.png" width="400"> | <img src="img-auditoria/image-21.png" width="400"> |
...
| :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-44.png" width="400"> | <img src="img-auditoria/image-45.png" width="400"> |
...
| :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-46.png" width="400"> | <img src="img-auditoria/image-47.png" width="400"> |
...
#### **D. Región de Controles Ignorad**a
...
<div
  class="controles"
  role="region"
  aria-label="Controles de búsqueda y filtrado"
>
  <!-- Inputs y botones... -->
</div>
```
...
- **Navegación por Flechas:** Se ha habilitado el _Roving Tabindex_, permitiendo moverse entre las pestañas con las flechas Izquierda/Derecha, comportamiento nativo esperado en aplicaciones de escritorio.
...
![Auditoría final WAVE: 0 Errores"](img-auditoria/image-22.png)
...
**Evidencia:**
![Puntuación Lighthouse: 100/100 en Accesibilidad](img-auditoria/image-23.png)
...
**Evidencia:**
![Validación axe DevTools: 0 problemas detectados](img-auditoria/image-24.png)
...
**Evidencia:**
<img src="img-auditoria/image-49.png" width="600" alt="Auditoría WAVE final en Login: 0 Errores">
...
**Evidencia:**
<img src="img-auditoria/image-48.png" width="600" alt="Auditoría Lighthouse final">
...
**Evidencia:**
<img src="img-auditoria/image-50.png" width="600" alt="Auditoría Axe final en Login: 0 Problemas">
...
| :----------------------------------: | :----------------------------------: | :----------------------------------: |
| <img src="img-auditoria/image-61.png" width="400"> | <img src="img-auditoria/image-62.png" width="400"> | <img src="img-auditoria/image-63.png" width="400"> |

---

## **INVENTARIO**

**Objetivo:** Certificar que la página de Inventario cumple con los estándares WCAG 2.1 tras todas las correcciones.

### **1. Evidencia de Conformidad**

Se presentan las capturas finales de las herramientas de validación, mostrando 0 errores críticos.

| Wave (Ver inventario) | Wave (Consolidar stock) | axe-devtools (Ver inventario) | axe-devtools (Consolidar stock) |
| :-------------------: | :---------------------: | :---------------------------: | :-----------------------------: |
| ![Wave](img-auditoria/image-68.png) |  ![Wave](img-auditoria/image-69.png)  | ![axe-devtools](img-auditoria/image-71.png) |  ![axe-devtools](img-auditoria/image-70.png)  |
...
**Estado Final:**
La página de inicio (`home.html`), del login (`index.html`), de gestión de artículos (`articulos.html`) y de inventario (`inventario.html`) cumple satisfactoriamente con los Criterios de Conformidad de las **WCAG 2.1**, validadas mediante una triangulación de herramientas líderes en la industria (WAVE, Lighthouse y Axe).
